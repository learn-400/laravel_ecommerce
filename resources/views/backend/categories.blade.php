                ...
                {{ Form::open($action) }}
                  <fieldset>
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        {{ Form::text('name', $name, array('type'=>'text','class'=>'span7 typeahead', 'id'=>'typeahead','data-provide'=>'typeahead','data-items'=>'4','data-source'=>'','placeholder'=>'Category Name','required')) }}
                    </div>
                </div>
                  ...
                  <tbody>
                   ...
                   <?php $i++; ?>
                    <tr>
                        ...
                        ?>
                        {{Form::open(array('url'=>['categories/'.$status.'/'.$v->id],'method'=>'put','style'=>'float:left'))}} 
                        ...
                        <a class="btn btn-info" href="{{Route('categories.edit',$v->id)}}" style="float:left">
                            <i class="icon-edit icon-white"></i>                      
                        </a>

                         {{ Form::open(array('route' => ['categories.destroy',$v->id],'method'=>'delete','style'=>'float: left;')) }}
                         {{Form::hidden('id',$v->id)}}
